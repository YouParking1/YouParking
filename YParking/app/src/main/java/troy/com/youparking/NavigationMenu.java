...
public class NavigationMenu extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(this, MyBidsActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_find_now) {
            Intent intent = new Intent(this, FindNowActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_hold_now) {
            Intent intent = new Intent(this, HoldSpot.class);
            startActivity(intent);

        } else if (id == R.id.nav_find_later) {
            Intent intent = new Intent(this, FindLaterActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_hold_later) {
            Intent intent = new Intent(this, HoldLaterActivity.class);
            startActivity(intent);
